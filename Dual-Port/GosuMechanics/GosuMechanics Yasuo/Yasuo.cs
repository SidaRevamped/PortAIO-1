        ...
        public static void WallJump()
        {
            if (Program.myHero.LSDistance(spot1) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot1.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
            ...
            if (Program.myHero.LSDistance(spot2) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot2.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot3) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot3.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot4) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot4.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot5) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot5.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot6) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot6.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot7) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot7.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot8) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot8.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot9) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot9.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot10) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot10.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot11) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot11.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot12) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot12.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot13) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot13.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot14) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot14.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot15) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot15.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spot16) <= 150)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.Q3.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spot16.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
        ...
        public static void WallDash()
        {
            if (Program.myHero.LSDistance(spotA) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotA.To3D()) && jungleMobs.CharData.BaseSkinName == "SRU_Blue" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotB) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotB.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Red" && jungleMobs.CharData.BaseSkinName != "SRU_RedMini4.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotC) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotC.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotE) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotE.To3D()) && jungleMobs.CharData.BaseSkinName == "SRU_KrugMini" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotF) <= 400)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotF.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Blue" && jungleMobs.CharData.BaseSkinName != "SRU_BlueMini1.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotG) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotG.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Murkwolf" && jungleMobs.CharData.BaseSkinName != "SRU_MurkwolfMini2.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotH) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotH.To3D()) && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotI) <= 120)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(100)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotI.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Murkwolf" && jungleMobs.CharData.BaseSkinName != "SRU_MurkwolfMini8.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotJ) <= 120)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotJ.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Murkwolf" && jungleMobs.CharData.BaseSkinName != "SRU_MurkwolfMini8.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotL) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotL.To3D()) && jungleMobs.CharData.BaseSkinName == "SRU_KrugMini" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotM) <= 200)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotM.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Red" && jungleMobs.CharData.BaseSkinName != "SRU_RedMini10.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.LSDistance(spotO) <= 200)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.LSIsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotO.To3D()) && jungleMobs.CharData.BaseSkinName != "SRU_Red" && jungleMobs.CharData.BaseSkinName != "SRU_RedMini10.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.LSIsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
