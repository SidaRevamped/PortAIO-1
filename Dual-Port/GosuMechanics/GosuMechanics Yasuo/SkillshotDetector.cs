...
namespace GosuMechanicsYasuo
{
    internal static class SkillshotDetector
    {
        ...
        private static void ObjSpellMissileOnOnCreate(GameObject sender, EventArgs args)
        {
            ...
            {
                //Console.WriteLine(Environment.TickCount + " Projectile Created: " + missile.SData.Name + " distance: " + missile.StartPosition.LSDistance(missile.EndPosition) + "Radius: " + missile.SData.CastRadiusSecondary[0] + " Speed: " + missile.SData.MissileSpeed);
            }
