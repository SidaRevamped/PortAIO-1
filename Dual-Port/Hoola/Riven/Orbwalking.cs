...
namespace HoolaRiven
{
    ...
    public static class Orbwalking
    {
        ...
        public static bool CanMove(float extraWindup, bool disableMissileCheck = false)
        {
            ...
            var extraWindupA = extraWindup + localExtraWindup + extraWindup;
            ...
            return !ObjectManager.Player.CanCancelAutoAttack() || (TickCount + (Game.Ping / 2) >= LastAATick + (ObjectManager.Player.AttackCastDelay * 1000) + extraWindupA);
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.Add("LastHit", new KeyBind("Last hit", false, KeyBind.BindTypes.HoldActive, 'Z'));
                _config.Add("Farm", new KeyBind("Mixed", false, KeyBind.BindTypes.HoldActive, 'C'));
                _config.Add("Freeze", new KeyBind("Freeze", false, KeyBind.BindTypes.HoldActive, 32));
                _config.Add("LaneClear", new KeyBind("LaneClear", false, KeyBind.BindTypes.HoldActive, 'V'));
                _config.Add("Flee", new KeyBind("Flee", false, KeyBind.BindTypes.HoldActive, 'G'));
                _config.Add("Burst", new KeyBind("Burst", false, KeyBind.BindTypes.HoldActive, 'T'));
                _config.Add("Orbwalk", new KeyBind("Combo", false, KeyBind.BindTypes.HoldActive, 'X'));
                _config.Add("FastHarass", new KeyBind("Fast Harass", false, KeyBind.BindTypes.HoldActive, 'J'));
                _config.Add("StillCombo", new KeyBind("Combo without moving", false, KeyBind.BindTypes.HoldActive, 'M'));
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (getKeyBindItem(_config, "FastHarass"))
                    {
            ...
            private void DrawingOnOnDraw(EventArgs args)
            {
                ...
                {
                    LeagueSharp.SDK.Core.Utils.Render.Circle.DrawCircle(
                ...
                if (getCheckBoxItem(drawings, "LastHitHelper"))
                {
                                ...
                                x => x.Name.ToLower().Contains("minion") && x.IsHPBarRendered && x.LSIsValidTarget(1000)))
                    {
                        ...
                        {
                            LeagueSharp.SDK.Core.Utils.Render.Circle.DrawCircle(minion.Position, 50, Color.LimeGreen);
                        }
                    }
                }
            }
